...
public class ContractLegalController {
	...
	public ContractLegalResource updateContratLegal(@PathVariable Long clientId, @PathVariable Long lawyerId,
			@PathVariable Long contratLegalId,  @Valid @RequestBody SaveContractLegalResource resource) {
		return convertToResource(contractLegalService.updateContractLegal(clientId, lawyerId, contratLegalId, convertToEntity(resource)));
	}
